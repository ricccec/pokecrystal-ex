...
.Frameset_CyberdyneLogo:
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_1,  15
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_2,   1
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_3,   1	; STEP
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_2,   4
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_1,  13	; MAX
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_2,  14
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_3,   1	; STEP
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_2,   4
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_1,  10	; MAX
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_2,  14
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_3,   4	; STEP
	...
	; Blinking
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_12,  12
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_4,   12
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_12,  12
	oamframe SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_4,   32
	; Transform
